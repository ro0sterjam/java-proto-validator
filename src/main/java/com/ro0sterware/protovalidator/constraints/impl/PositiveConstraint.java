...
/** Constraint that validates that a number typed field is positive. */
public class PositiveConstraint extends AbstractNumberConstraint {
  ...
  public String getViolationErrorCode() {
    return "field.violations.Positive";
  }
}
