...
/** Constraint that validates that a number typed field is negative or zero. */
public class NegativeOrZeroConstraint extends AbstractNumberConstraint {
  ...
  public String getViolationErrorCode() {
    return "field.violations.NegativeOrZero";
  }
}
