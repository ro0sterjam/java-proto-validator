...
/** Constraint that validates that a message or enum typed field is not set. */
public class IsNotSetConstraint implements FieldConstraint {
  ...
  public String getViolationErrorCode() {
    return "field.violations.IsNotSet";
  }
}
